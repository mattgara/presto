...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(FeaturesConfig.class)
                ...
                .setReconsiderLowConfidenceFilterBroadcastEnabled(false)
                .setLowConfidenceFilterBroadcastScaleFactor(1.0)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("optimizer.reconsider-low-confidence-filter-broadcast", "true")
                .put("optimizer.low-confidence-filter-broadcast-scale-factor", "0.05")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setReconsiderLowConfidenceFilterBroadcastEnabled(true)
                .setLowConfidenceFilterBroadcastScaleFactor(0.05)
